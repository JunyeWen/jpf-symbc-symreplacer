...
public class ProblemZ3Replace extends ProblemGeneral {
  ...
  //we would likely encounter a linker error
	...
	private Map<String, Object> concreteValueMapping;

	public ProblemZ3Replace(Map<String, Object> map) {
		Z3Wrapper z3 = Z3Wrapper.getInstance();
		solver = z3.getSolver();
		ctx = z3.getCtx();
		solver.push();
		useFpForReals = SymbolicInstructionFactory.fp;
		concreteValueMapping = map;
	}
